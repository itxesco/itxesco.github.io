...
O RPG (Role-Playing Game) é um **jogo de interpretação de papéis** em que os participantes interpretam personagens fictícios e  constroem coletivamente uma história, com cenário construído e situações guiadas  por um narrador (que também é chamado de Mestre do Jogo ou DM – Dungeon Master).

O jogo não tem tabuleiro fixo nem objetivo final. Tudo é determinado pela imaginação, pelas regras do sistema adotado e pelo diálogo entre jogadores. Os personagens têm **atributos e habilidades** definidos em fichas, que orientam as ações possíveis e os testes feitos com dados.  
...
## Como funcionam as rolagens no sistema D20 (estatisticamente falando)

### 🎲 1. O básico: rolagem de 1d20 + modificadores

No sistema D20 (usado em *Dungeons & Dragons*, *Pathfinder*, *Tormenta RPG*, etc.), a maioria das ações é resolvida assim: 1d20 + modificador ≥ Classe de Dificuldade (CD)

- **1d20**: significa rolar um dado de 20 lados
- **Modificador**: bônus (ou penalidade) baseado em atributos, perícias, talentos
- **CD**: valor-alvo definido pelo Mestre para o teste

---

### 📐 2. Distribuição estatística do d20

O dado de 20 lados (d20) tem uma **distribuição uniforme**, o que significa que cada número de 1 a 20 tem **5% de chance** de sair.

- Exemplo: chance de tirar **15 ou mais** = 6 números possíveis (15 a 20) = **30%**
- Exemplo: chance de tirar **10 ou mais** = 11 números possíveis = **55%**

---

### 🧮 3. Cálculo da probabilidade de sucesso

Você pode calcular a chance de sucesso com a fórmula:  Probabilidade = (21 - (CD - Modificador)) / 20  
...
Você precisa tirar 12 ou mais (porque 12 + 3 = 15)  

Números válidos: 12, 13, 14, 15, 16, 17, 18, 19, 20 → 9 possibilidades
Chance de sucesso = 9 / 20 = 45%  

---

### 📊 4. Tabela rápida de chance de sucesso (sem modificador)

| Número mínimo no dado | Chance de sucesso |
|-----------------------|-------------------|
| 20                    | 5%                |
| 15                    | 30%               |
| 10                    | 55%               |
...
*Cada ponto de modificador equivale a 5% a mais (ou menos) na chance de sucesso.*

---

### 💥 5. Crítico e falha automática

Por padrão nos jogos D20:

- **20 natural** (rolado no dado) = **acerto crítico**
- **1 natural** = **falha crítica**

Esses eventos têm **5% de chance** cada, independentemente do modificador.

---

### 📉 6. Comparação com sistemas "não-lineares"

| Sistema        | Tipo de distribuição       | Impacto nos testes                   |
|----------------|----------------------------|--------------------------------------|
| **D20**        | Uniforme                   | Cada +1 equivale a +5% de chance     |
| **GURPS (3d6)**| Gaussiana (curva normal)   | Valores médios são mais prováveis; extremos são raros |
